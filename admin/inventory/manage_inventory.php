...
<input type="number" min="0" class="form-control form" required name="quantity" value="<?php echo isset($quantity) ? $quantity : '' ?>">
<small class="text-muted">Update this value anytime to restock product</small>
            </div>
            <div class="form-group">
