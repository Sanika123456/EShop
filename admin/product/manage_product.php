...
<div class="card card-outline card-info">
    ...
    <input type="number" step="0.01" min="1" name="price" id="price" class="form-control rounded-0" required
    value="<?php echo isset($price) ? $price : '' ?>">
</div>

<div class="form-group">
    <label for="quantity" class="control-label">Stock Quantity</label>
    <input type="number" min="0" name="quantity" id="quantity" class="form-control rounded-0" required
